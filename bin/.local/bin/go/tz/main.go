...
func main() {
	...
	peeps = append(peeps, "David Cho: " + now.In(loc).Format(time.Kitchen))
	...
	peeps = append(peeps, "Tim:       " + now.In(loc).Format(time.Kitchen))
	...
	peeps = append(peeps, "Jason:     " + now.In(loc).Format(time.Kitchen))
